...
sed -i "s|{consoleHost}|${consoleHost}|g" ${yaml_dir}/ingress.yaml
sed -i "s|{storageClass}|${storageClass}|g" ${yaml_dir}/pvc.yaml

# install
kubectl apply -f ${yaml_dir}/certificate.yaml
